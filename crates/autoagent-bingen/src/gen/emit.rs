...
function triple() {
  ...
  throw new Error(`@autoagent-sdk/native: unsupported platform ${platform}-${arch}`)
}
...
fn node_sdk_index() -> String {
    ...
    out.push_str("// DO NOT EDIT — generated by autoagent-bingen from bind.rs.\n");
    out.push_str(
        r#"// AutoAgent — typed Node.js SDK over the native bindings (@autoagent-sdk/native).
